<!-- AUTO-GENERATED: docs/doc-inventory.md — do not edit manually. Regenerate: python scripts/doc_inventory.py -->

## Doc Inventory

| Path | Size (bytes) | Type |
|------|-------------:|------|
| AGENTS.md | 39071 | file |
...
| docs/dev/developer-guide.md | 22521 | file |
| docs/dev/evaluation-matrix-principles.md | 39285 | file |
| docs/dev/forward-compat.md | 12884 | file |
| docs/dev/founder-expectations.md | 110610 | file |
| docs/dev/gate-failure-modes.md | 20840 | file |
| docs/dev/override-reference.md | 9343 | file |
| docs/dev/project-validation-framework.md | 12552 | file |
