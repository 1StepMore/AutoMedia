...
* **audit:** append-only review-decision audit log at user level ([0180995](https://github.com/1StepMore/AutoMedia/commit/0180995605ecec0b32089afd4d6de8115ddc1967))
* **brand:** feed cta_principles to the content-writer gate ([11b8c54](https://github.com/1StepMore/AutoMedia/commit/11b8c54ca8b77596e7e7ce01bcccbd034032ccd9))
* **brand:** let add_brand set gate-consumed fields ([52eaea7](https://github.com/1StepMore/AutoMedia/commit/52eaea7e81c616ecde1ff1fbd8ea7d523701ddf9))
* **ci:** validation CI wiring (affected-area mapper + runner + workflows) ([02c6333](https://github.com/1StepMore/AutoMedia/commit/02c6333ff6b31d4de6cc30f72007382ae2ab997a))
* **cli+mcp:** add pipeline state view (CLI table + get_pipeline_state tool) ([b308083](https://github.com/1StepMore/AutoMedia/commit/b308083bdb6e5ac45f9df99d64fff730bfeaacc0))
* **cli:** add --skip-review for unattended runs ([71631f0](https://github.com/1StepMore/AutoMedia/commit/71631f0d0a62029a1f1cbf38926d9125d4187b44))
* **cli:** add automedia pipeline export-dag (Markdown + DOT, per-mode + per-run) ([eb50d8e](https://github.com/1StepMore/AutoMedia/commit/eb50d8e7a82fdcffec3001669c6dfa0d96127f11))
* **cli:** add real/stub/json filters to adapter list for platform audit ([4065f8c](https://github.com/1StepMore/AutoMedia/commit/4065f8c54ed53c9f9ee1f9296c46b65bfdd2dc42))
* **cli:** doctor reports advisory LLM configuration warnings ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([33a80b2](https://github.com/1StepMore/AutoMedia/commit/33a80b2fb63ec9a012a3b7af0140731011c03d70))
* **config:** validate merged config shape/type before returning ([5802b5f](https://github.com/1StepMore/AutoMedia/commit/5802b5f42b3bfbd3a9de71c2e526aae207a5483c))
* **detectors:** ai-taste detector framework + G1 humanize-verify loop ([#62](https://github.com/1StepMore/AutoMedia/issues/62)) ([ba89e22](https://github.com/1StepMore/AutoMedia/commit/ba89e22b776be1bdf112c4470b951f9bd1c296aa))
* **detectors:** env-gated external detector adapter ([54b21fb](https://github.com/1StepMore/AutoMedia/commit/54b21fbf4c244435bda66ff26cc82cd46a9213f8))
* **detectors:** pluggable AI-taste detector framework (base+registry) ([5a9c85e](https://github.com/1StepMore/AutoMedia/commit/5a9c85e2576f01dce6c5572062aecab754f3a93b))
* **docs:** wire link/identifier/marker checks into doc gate; add generated doc inventory (doc-hardening-pass2 step 3+4) ([f0223f4](https://github.com/1StepMore/AutoMedia/commit/f0223f48c40c306e5ce425d1c1dc7f8500234b9b))
* **features:** add declarative FEATURE_TIERS and check_tier marker ([30ab64b](https://github.com/1StepMore/AutoMedia/commit/30ab64b9296bf4143989b95826c6242ed1673130))
* **features:** filter gates by tier at composition, no-op by default ([6dfc110](https://github.com/1StepMore/AutoMedia/commit/6dfc110ba82723cebafd26e8574d8d252d883cc3))
* **gates:** Chinese AI-taste detection (G1) + bidirectional fact-check (G0) ([#73](https://github.com/1StepMore/AutoMedia/issues/73)) ([4f5b219](https://github.com/1StepMore/AutoMedia/commit/4f5b21955ae2258ec6efbedc10f17fc9e82f759e))
* **gates:** G1 humanize-verify loop with detector_score (off by default) ([#62](https://github.com/1StepMore/AutoMedia/issues/62)) ([5c258e5](https://github.com/1StepMore/AutoMedia/commit/5c258e56460f06d4a363b7d6d05eeb41774f51e7))
* **lifecycle:** gate distribution on L3 ([615cced](https://github.com/1StepMore/AutoMedia/commit/615cced93809595fd7eb4b8bbd9a3d6e9a29967d))
* **lifecycle:** gate the archive entry points on L2 ([f4ff3e9](https://github.com/1StepMore/AutoMedia/commit/f4ff3e95a081a5e83e18acaba27b1a54826b7264))
* **lifecycle:** produce publish_log and gate publishing on L1 ([0eaf429](https://github.com/1StepMore/AutoMedia/commit/0eaf4297715369c2767301c20ff31e00122749ea))
* **llm:** add merge-preserving save_model_config writer ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([239ccce](https://github.com/1StepMore/AutoMedia/commit/239cccea81fabc0cab8affa9c11183267b1ca1a2))
* **llm:** provider fallback chain for llm_complete family ([#71](https://github.com/1StepMore/AutoMedia/issues/71)) ([f048814](https://github.com/1StepMore/AutoMedia/commit/f0488144d5972541d29a352e11c375898a13a54b))
* **mcp:** add authenticated HTTP transport and a working allowlist override ([33d1d03](https://github.com/1StepMore/AutoMedia/commit/33d1d031f29d18d6d8e5c5c1db3e44ca96d2c898))
* **mcp:** add get_gate_report tool reading 05_review/gate-report ([c22462d](https://github.com/1StepMore/AutoMedia/commit/c22462de53ecc9d6eedc22029aa6892ff8e4effa))
* **mcp:** add review_decision on the live H0 path and make reject halt the pipeline ([0be8f87](https://github.com/1StepMore/AutoMedia/commit/0be8f87d01b463804835959af2362aeac36f5d26))
* **mcp:** persist topic pool by default ([aecfef4](https://github.com/1StepMore/AutoMedia/commit/aecfef4ec26ad4e628c259ebec1898f1137c6932))
* **pipeline:** produce the video track before the V gates and report skipped honestly ([380d2fd](https://github.com/1StepMore/AutoMedia/commit/380d2fd8ee2e066f46ee6ddd3b64cb7df106db23))
* **pipelines:** add canonical gate DAG with topo-order + downstream helpers (additive, zero behavior delta) ([9691823](https://github.com/1StepMore/AutoMedia/commit/9691823ef6ba6e2a7507ac1ca695ae202f4b35a6))
* **pipelines:** add gate-report writer rendering existing per-gate data ([ff86726](https://github.com/1StepMore/AutoMedia/commit/ff86726ffd8db0f4284aa2d0fa4d92f5b47901db))
* **pipelines:** aggregate per-gate pipeline state from history + md5 (read-only) ([11c7348](https://github.com/1StepMore/AutoMedia/commit/11c7348bcf7bba952dec2e23c09480a019e252a4))
* **pipelines:** auto-generate gate-report at end of every production run ([ece59fe](https://github.com/1StepMore/AutoMedia/commit/ece59fea37fbc2c5a8f856db41d8893796ae7372))
* **pipelines:** opt-in auto-resume from last passed gate (CLI/MCP/SDK) ([f354ee2](https://github.com/1StepMore/AutoMedia/commit/f354ee2e21d6d114a59e0db8b504aaac90f1a8a9))
* **pipelines:** persist per-gate before/after diff records under .automedia/gate_diffs ([a377daf](https://github.com/1StepMore/AutoMedia/commit/a377daf3ba4b56099510a400bb6a341da5b6cfef))
* **pipelines:** report downstream-affected gates on failure (new PipelineResult field) ([fe67768](https://github.com/1StepMore/AutoMedia/commit/fe6776840450f8d5ae6815c996c0a2b244412fc1))
* **report:** add remediation column to gate-report ([7ae61b9](https://github.com/1StepMore/AutoMedia/commit/7ae61b93f4307c52b7b2c7be362676e48a44eb61))
* **report:** self-contained HTML gate report ([16c149b](https://github.com/1StepMore/AutoMedia/commit/16c149b863384973c7e338b6434faa9fdbd0d1b0))
* **scenarios:** distribution D-gates journey proving D1-D7 ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([6f70d83](https://github.com/1StepMore/AutoMedia/commit/6f70d83f40bd85dfe6dbbc1541b63774b50af165))
* **scenarios:** mode journeys proving all 9 pipeline modes ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([22fed99](https://github.com/1StepMore/AutoMedia/commit/22fed99b83e083bccb752a80c6e9eb235829cb49))
* **scenarios:** validation scenario library (91 scenarios + standards handbook + baseline) ([fe1be17](https://github.com/1StepMore/AutoMedia/commit/fe1be17d8980dcf170521d831a5fad9420942e82))
* **scripts:** one-command AutoMedia MCP setup for agent clients ([eab6dfe](https://github.com/1StepMore/AutoMedia/commit/eab6dfecf026594f383f08188357e95a75da1fd5))
* **topics:** persist research_topics into the pool ([e0b8224](https://github.com/1StepMore/AutoMedia/commit/e0b82249e099474ff5840ae5b0534433af47e5a5))
* **trace:** stamp the in-flight correlation id onto MCP tool responses ([b1c48a0](https://github.com/1StepMore/AutoMedia/commit/b1c48a0ebd4f4fdbca2f303ca8bd821b5d666daf)), closes [#13](https://github.com/1StepMore/AutoMedia/issues/13)
* **validate:** automedia validate CLI + 4 MCP validation tools + report/diff/signoff/regression ([a7c9609](https://github.com/1StepMore/AutoMedia/commit/a7c96094c9e37a1a380e590ff428b60b2e94d6c1))
* **validation:** agent-tester validation engine (schema/loader/standards/adapters/expects/env-gate/engine/persist) ([a28ccbe](https://github.com/1StepMore/AutoMedia/commit/a28ccbe514e725a1f74f51903ba69608a638c8f0))
* **validation:** AutoInfo-style artifact-assertion matrix for validate matrix ([#86](https://github.com/1StepMore/AutoMedia/issues/86)) ([ae1c138](https://github.com/1StepMore/AutoMedia/commit/ae1c138e20ec1f68573e2ceb55d7adca4e7c8ad6))
* **validation:** AutoInfo-style matrix + hard safety + diff upgrade ([#86](https://github.com/1StepMore/AutoMedia/issues/86)) ([f09f927](https://github.com/1StepMore/AutoMedia/commit/f09f9271655cd450a3b105e125f30d3a3f595c52))
* **validation:** deterministic fake-LLM path ([893b8de](https://github.com/1StepMore/AutoMedia/commit/893b8de99dfed1740c45d4878d4ade0f5d6a0c1a))
* **validation:** director sign-off surface ([a28b73c](https://github.com/1StepMore/AutoMedia/commit/a28b73caf804346fd2807b99b86bb71315442f0e))
* **validation:** emit AX metrics ([ea776d7](https://github.com/1StepMore/AutoMedia/commit/ea776d7bdb155673af4ef62cb23846a2a1c4c058))
* **validation:** enforce standard check-types and non-empty expects ([afb13df](https://github.com/1StepMore/AutoMedia/commit/afb13df173e00b338489122d9f2dae12e58ca5c9))
* **validation:** error envelopes fail steps unless opted out ([ce6544b](https://github.com/1StepMore/AutoMedia/commit/ce6544b072f8fdbfde2b7feacae0fadb503fd97f))
* **validation:** error-quality assertions ([28c6fcb](https://github.com/1StepMore/AutoMedia/commit/28c6fcb3250b29ebe13ac58c930997bdd75eb63b))
* **validation:** evidence-backed coverage ([2ad0b93](https://github.com/1StepMore/AutoMedia/commit/2ad0b931e98023cc253b2b76b8f65e2f87873f74))
* **validation:** gate and mode coverage audit surfaces ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([ad66950](https://github.com/1StepMore/AutoMedia/commit/ad6695033a8c77542ce1d51ae1920bc4d7e3c3cb))
* **validation:** gate/mode coverage audit + scenarios proving all 9 modes and D-gates ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([168f47f](https://github.com/1StepMore/AutoMedia/commit/168f47fc5bb9ac9851bd327c3574e8b45bdd3ca6))
* **validation:** mark safety-critical scenarios hard and regenerate full-suite baseline ([5c59146](https://github.com/1StepMore/AutoMedia/commit/5c591467f6c5727f39f78ec1b1796af5e527706e))
* **validation:** suite run, persistence, sign-off ([99802b0](https://github.com/1StepMore/AutoMedia/commit/99802b07a6d9a8e90e05cf260ec041ab4720d736))
* **validation:** trace propagation assertion ([60d1f4f](https://github.com/1StepMore/AutoMedia/commit/60d1f4fcb1aed3f545e67e5d8608e5210c12eed0))
* **validation:** track gates and modes proven by scenarios ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([5b2089c](https://github.com/1StepMore/AutoMedia/commit/5b2089c3eb7c74c189404b10fa437a16d71d72a9))
* **validation:** user-level dimension ([0f08c94](https://github.com/1StepMore/AutoMedia/commit/0f08c9447ea920d00e550c706dc64a1a3618afaa))


### Bug Fixes

* **accounts:** remove duplicate HealthStatus export (RUF068) ([11ff977](https://github.com/1StepMore/AutoMedia/commit/11ff977f55b6e714dee75944a8e158d4ad0c368d))
* **archive scenario:** expect PROJECT_ID ([174edbf](https://github.com/1StepMore/AutoMedia/commit/174edbf685443c421fb844bffbf00a18d4460aac))
* **archive scenario:** expect project_id (lowercase, matching CLI output) ([d3e39e2](https://github.com/1StepMore/AutoMedia/commit/d3e39e2ed5eae0973bd6b4fb69ffd82285b33ddb))
* **asset-library:** coerce VectorStore.count() result to int for strict mypy ([994ff1c](https://github.com/1StepMore/AutoMedia/commit/994ff1c923211f72fdaf7fa3627f5f46fd350067))
* **brand:** read the correct aliases key ([dfeb8be](https://github.com/1StepMore/AutoMedia/commit/dfeb8becf31bea2978cdc2929ac3e529c85c491b))
* **ci:** pin uv, bound the lock's Python range, and floor anyio ([#94](https://github.com/1StepMore/AutoMedia/issues/94)) ([392809b](https://github.com/1StepMore/AutoMedia/commit/392809bf98e139398af12101f8689c8211c11fe8))
* **ci:** pin uv, bound the lock's Python range, and floor anyio ([#94](https://github.com/1StepMore/AutoMedia/issues/94)) ([8d0c2eb](https://github.com/1StepMore/AutoMedia/commit/8d0c2eba978128e07529536d3ba1a60ba995f810))
* **ci:** repair invalid Nightly workflow and clear RUF068 lint failure ([873b55b](https://github.com/1StepMore/AutoMedia/commit/873b55b03546b2f6d36673ec8ae42e12b253cffc))
* **ci:** scope the uv lock to Linux/py3.13 and bump anyio for the nightly ([#91](https://github.com/1StepMore/AutoMedia/issues/91)) ([847b447](https://github.com/1StepMore/AutoMedia/commit/847b447c636ef676244e3ec32de95fba8ce87688))
* **ci:** scope the uv lock to Linux/py3.13 and bump anyio for the nightly ([#91](https://github.com/1StepMore/AutoMedia/issues/91)) ([fbafcc7](https://github.com/1StepMore/AutoMedia/commit/fbafcc7315191ecef1d4bd6a0aa163d7abbc7be4))
* **cli:** init preserves fallback chain + interactive fallback guidance ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([95e7080](https://github.com/1StepMore/AutoMedia/commit/95e70806c48f6250ddbbdd1de838e39bbb8d33ff))
* **cli:** non-zero exit on gate failure ([a1e2f67](https://github.com/1StepMore/AutoMedia/commit/a1e2f6763ca8a2411f345b7947b6eb77b4b6275b))
* **cli:** onboard step preserves fallback chain + fallback guidance ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([265934d](https://github.com/1StepMore/AutoMedia/commit/265934df5e9b86a165d189d3a597d62163927540))
* **cli:** pin archive project_id metavar for stable --help ([22cfbf5](https://github.com/1StepMore/AutoMedia/commit/22cfbf5c79ddbd7120757223f77b7068c099b40b))
* **cli:** surface project-scan errors instead of reporting not-found ([964ab56](https://github.com/1StepMore/AutoMedia/commit/964ab56aed90c755243679f37eb60540daba8e15))
* **cron:** --due dispatch and fire pool bridge ([8dfe128](https://github.com/1StepMore/AutoMedia/commit/8dfe128da03cf7e2e5003bd57efd5cdb4ea9cd1f))
* **deps:** bump cryptography/Pillow for CVEs and fix Nightly uv extras ([30c0a94](https://github.com/1StepMore/AutoMedia/commit/30c0a94d43b3210c5d4179c8b27e8ca42263b96e))
* **deps:** bump cryptography&gt;=50.0.0 and Pillow&gt;=12.2.0 for CVEs ([337ad48](https://github.com/1StepMore/AutoMedia/commit/337ad4875c903422024998b5901bb3b9b133d807))
* **doctor:** bounded LLM probe; stop the false-positive ([81491aa](https://github.com/1StepMore/AutoMedia/commit/81491aa579c9eab3f3d059a0c102f1813b9bb562))
* **gates:** rewrite removes sentence-initial patterns at every sentence start ([#75](https://github.com/1StepMore/AutoMedia/issues/75)) ([372adc0](https://github.com/1StepMore/AutoMedia/commit/372adc0ecf2606c1b8974219d2f7436e64b7a973))
* **hitl:** make the live-HITL marker per-run so runs cannot read each other's marker ([27a5f64](https://github.com/1StepMore/AutoMedia/commit/27a5f64c63c5f41176be9a7f43bda49d3db5b526)), closes [#17](https://github.com/1StepMore/AutoMedia/issues/17)
* **lifecycle:** real source_lang + advisory L4 in MCP localize ([398daea](https://github.com/1StepMore/AutoMedia/commit/398daeaf41628d6d471b4f6bffe5862e8221c6af))
* **lint:** resolve vulture findings and stale mypy ignores ([#88](https://github.com/1StepMore/AutoMedia/issues/88)) ([86836b1](https://github.com/1StepMore/AutoMedia/commit/86836b1354abf8c0d265fdd8aa95beef8187aaae))
* **lint:** resolve vulture findings via whitelist and drop stale mypy ignores ([#88](https://github.com/1StepMore/AutoMedia/issues/88)) ([0a41523](https://github.com/1StepMore/AutoMedia/commit/0a4152302511dfe5427679e5c28e08f5834641cc))
* **llm:** handle fenced-JSON structured output from schema-ignoring providers ([7c949cb](https://github.com/1StepMore/AutoMedia/commit/7c949cb46ff929e8ab98810ed8a94c5630bea958))
* **lock:** regenerate uv.lock on the default PyPI index ([89b1038](https://github.com/1StepMore/AutoMedia/commit/89b103851363d6da5aea773aac7fe0fea3ef0f54))
* **mcp:** configure_llm/onboard preserve LLM fallback via merge ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([202b188](https://github.com/1StepMore/AutoMedia/commit/202b18821e9a7ff1b1ee8d8afc732d79b093062e))
* **mcp:** gate single-platform publish on the requested platform ([#92](https://github.com/1StepMore/AutoMedia/issues/92)) ([b2e6389](https://github.com/1StepMore/AutoMedia/commit/b2e6389b5f0380a81e562189e0bd63708b311abd))
* **mcp:** gate single-platform publish on the requested platform ([#92](https://github.com/1StepMore/AutoMedia/issues/92)) ([58ebd0e](https://github.com/1StepMore/AutoMedia/commit/58ebd0e0364ffcbc2d2337e9a997d735652bf350))
* **mcp:** make the tool layer importable and installable on Windows ([2f764d3](https://github.com/1StepMore/AutoMedia/commit/2f764d350c4d466e6196255eb95f020caaa88ae1))
* **pipelines:** apply gate modified_content before each quality retry ([e897c79](https://github.com/1StepMore/AutoMedia/commit/e897c7984c83d351bf67e5a16f4a359bfd714bf3))
* **pool:** close SQLite connections so Windows teardown stops locking ([07679df](https://github.com/1StepMore/AutoMedia/commit/07679dfb7cd5bcd3c2b77d075f9659afbd02823a))
* **pool:** PoolDB._open creates parent dir (OperationalError) (renanzai40/AutoMedia_BackUp[#1](https://github.com/1StepMore/AutoMedia/issues/1)) ([3ef3a3b](https://github.com/1StepMore/AutoMedia/commit/3ef3a3b2bf4044e30b4cfa1158ca166635c4fa51))
* **release-please:** bump the package version file on release via extra-files ([16ec6e7](https://github.com/1StepMore/AutoMedia/commit/16ec6e758cabc82c11b0fa884c7dbea7bf43856d))
* **release-please:** bump the package version file on release via extra-files ([f22f351](https://github.com/1StepMore/AutoMedia/commit/f22f351a65397587f5eaa5904de56cafcaaddbb2))
* **report:** keep remediation fields in gate-report ([be8c8c8](https://github.com/1StepMore/AutoMedia/commit/be8c8c819bf363b58822bfa3989043ebaab6dd87))
* **runner:** align production presets with producible inputs ([beb80cc](https://github.com/1StepMore/AutoMedia/commit/beb80cc208f3c2bb3f210edeb1a725ee840b511a))
* **security:** clear Nightly bandit findings and stabilize archive --help ([35e8672](https://github.com/1StepMore/AutoMedia/commit/35e86725416f5b2e490d9ea9405b65441d01182c))
* **security:** mark integrity-only MD5 digests usedforsecurity=False ([1df2561](https://github.com/1StepMore/AutoMedia/commit/1df2561e6ab0cbcd97e4f2e0d416dfafb5babe3b))
* **security:** restrict pipeline urlopen to http(s) schemes ([ebb2bbd](https://github.com/1StepMore/AutoMedia/commit/ebb2bbdc6465beae1b6f160f09da234db047db6d))
* **tests:** rename gate-report probe gate off G62 band (collides with retry_sites) ([72ed1ea](https://github.com/1StepMore/AutoMedia/commit/72ed1ea6517807ddf472d465659d80d4d4c0172d))
* **types:** enforce and satisfy strict typing on hardened modules ([1e5bd2b](https://github.com/1StepMore/AutoMedia/commit/1e5bd2bcdddf3d7bdfdeccd6d9a62474ef60f248))
* **types:** satisfy ruff ANN401 on the FastMCP dispatch wrapper ([1c45033](https://github.com/1StepMore/AutoMedia/commit/1c45033a42ed3b9d1bfc6bd5f1481dbdba22512c))
* **validation:** deterministic fake-LLM draft content for mode journeys ([154c275](https://github.com/1StepMore/AutoMedia/commit/154c275180e00cade537806a4db36b9af8f8d489))
* **validation:** feature-tier scenario asserts pro-gate inclusion ([54d5653](https://github.com/1StepMore/AutoMedia/commit/54d56532f6f967ae5a31d4a90d8db98f85747664))
* **validation:** final-wave review fixes — regression pin for update_engine_config defect + portable interpreter paths ([c5dddee](https://github.com/1StepMore/AutoMedia/commit/c5dddee281919e355b3e9c72640ad5e7294906d3))
* **validation:** gate_records_pass inspects entry status ([735d4cb](https://github.com/1StepMore/AutoMedia/commit/735d4cb9a5bb2a283a90b2933fcbc239443179b6))
* **validation:** immutable baseline regeneration ([170112a](https://github.com/1StepMore/AutoMedia/commit/170112acf460a7a3d672a7f3ebf5c76dfc273b6a))
* **validation:** immutable per-run artifact collection ([3f87adc](https://github.com/1StepMore/AutoMedia/commit/3f87adc423f6c40a47acbbe5d1a88e89a15a244b))
* **validation:** isolate account registry via AUTOMEDIA_CONFIG_DIR (renanzai40/AutoMedia_BackUp[#1](https://github.com/1StepMore/AutoMedia/issues/1)) ([f32aec7](https://github.com/1StepMore/AutoMedia/commit/f32aec7fef91bfbf11bdf58f296e0db6458f168d))
* **validation:** silence checkov CKV_SECRET_6 false positive on synthetic fixture key ([#70](https://github.com/1StepMore/AutoMedia/issues/70)) ([e3fb971](https://github.com/1StepMore/AutoMedia/commit/e3fb97127a38c55acf3d95715903b2176aa82f6b))
* **validation:** suppress bandit B108 on the live-HITL marker constants ([#24](https://github.com/1StepMore/AutoMedia/issues/24)) ([733e214](https://github.com/1StepMore/AutoMedia/commit/733e214f01a8d4b42ba8535b50d363997e618324))
* **validation:** suppress bandit B108 on the live-HITL marker constants ([#24](https://github.com/1StepMore/AutoMedia/issues/24)) ([c33617e](https://github.com/1StepMore/AutoMedia/commit/c33617ee52299aaaf4360c7d896f454454e9a25a))
* **validation:** trust flags, record shape, audit freshness ([5c846b6](https://github.com/1StepMore/AutoMedia/commit/5c846b61927a5385b90c87b7ec27cbac9f6c65d1))


### Documentation

* **acceptance:** first formal acceptance run report for 1.4.0 (84/0/7, real LLM) ([#76](https://github.com/1StepMore/AutoMedia/issues/76)) ([8c7b5ca](https://github.com/1StepMore/AutoMedia/commit/8c7b5caf07891729f07aba5b0233ee6da6c7be18))
* **adapters:** annotate real/notifier/manual-stub status across roadmap + founder expectations ([485b68a](https://github.com/1StepMore/AutoMedia/commit/485b68ab81f21e964cdac77bac605a40f60f110d))
* add ADR README, archived dir, doc-inventory rows to AGENTS.md doc index (doc-hardening-pass2 step 9) ([44f8f47](https://github.com/1StepMore/AutoMedia/commit/44f8f47e400c8007f3dd279ed46ceee407c3f6fb))
* add ADR TEMPLATE.md and README.md index to docs/adr/ ([42c33d1](https://github.com/1StepMore/AutoMedia/commit/42c33d1a5ba688e942758a1badcf79a960c54b7f))
* add graph-engineering rollout to CHANGELOG [Unreleased]; refresh stale surface-count docstrings (64-&gt;65, 90-&gt;105, 18-&gt;19) ([64a594f](https://github.com/1StepMore/AutoMedia/commit/64a594faf92f01dfad59beb4e03411deb72fa506))
* add graph-engineering source docs (research report + implementation plan, corrected versions) ([06301aa](https://github.com/1StepMore/AutoMedia/commit/06301aa183c19b05e2bdb5413f6f6c12aab3d7c5))
* agent documentation stack alignment ([faf1108](https://github.com/1StepMore/AutoMedia/commit/faf1108d683a504befc290e9f434ff26f1e485b8))
* **agents:** expand [mcp] install literal to satisfy red-line enforcement ([312b881](https://github.com/1StepMore/AutoMedia/commit/312b88162828ff9bc718c6695b5f0bea8a547e67))
* align 12 docs with graph-engineering ground truth (65/19 counts, _MODE_MAP compositions, ADR-006 index, --auto-resume/affected_downstream/pipeline state mentions) ([6eeaec2](https://github.com/1StepMore/AutoMedia/commit/6eeaec2e7c902e68881cd19c622e81d80006b203))
* archive one-off validation reports to docs/archived/ with status markers; drop mkdocs nav entry; index pointer ([4e43ea8](https://github.com/1StepMore/AutoMedia/commit/4e43ea897818f026d957157b143d98221713a835))
* **business:** correct verified factual errors vs codebase ([5dbd4f0](https://github.com/1StepMore/AutoMedia/commit/5dbd4f0e685a568d2b1b5536d135e21900aa2d17))
* correct founder-expectations collection claims ([fd9a52f](https://github.com/1StepMore/AutoMedia/commit/fd9a52fd4c5e6a256c48a19e9a831e6d78fcc431))
* correct publish_log path to 06_publish ([b11b132](https://github.com/1StepMore/AutoMedia/commit/b11b1329560b266325248fb4b6a51651bb646404))
* **eval:** add project evaluation pain points 2026-09-06 ([d47043b](https://github.com/1StepMore/AutoMedia/commit/d47043bbe3e629a92b0331980b7d0b053af8eec2))
* **gates:** document G1 verify-loop failure mode, env vars, and changelog ([#62](https://github.com/1StepMore/AutoMedia/issues/62)) ([f81c94a](https://github.com/1StepMore/AutoMedia/commit/f81c94a88b59b39d21cc8e616e0da6add619e9d1))
* **llm:** document fallback preservation + doctor LLM warnings ([#83](https://github.com/1StepMore/AutoMedia/issues/83)) ([4ee93cf](https://github.com/1StepMore/AutoMedia/commit/4ee93cf4c8a47d47c10bd738387dc30c4c4dea3d))
* **loop-log:** add the 2026-09-13 fix-retro block, four pitfalls, and the CI-red event ([723739c](https://github.com/1StepMore/AutoMedia/commit/723739cdc359904b3964b70dadeb19315e6efa0b))
* **readme:** concrete OpenClaw MCP configuration snippet ([522fca3](https://github.com/1StepMore/AutoMedia/commit/522fca3820f011c325ee7145c04724750490a288))
* **readme:** correct adapter real/stub counts and status table ([0613214](https://github.com/1StepMore/AutoMedia/commit/061321479c009eb7baa2b97aa1b6dae05f7c0d9f))
* **readme:** point badges and links at the canonical 1StepMore/AutoMedia repo ([8518790](https://github.com/1StepMore/AutoMedia/commit/85187900fc103ba86d5f16f6e848f41d6fb77db4))
* regenerate doc-inventory after graph-engineering doc updates (file sizes) ([2e45be9](https://github.com/1StepMore/AutoMedia/commit/2e45be9fbf7b6a4be6ca76dc52ab98e950445e1c))
* **repo:** point ownership and publishing docs at canonical 1StepMore/AutoMedia ([b2de3d2](https://github.com/1StepMore/AutoMedia/commit/b2de3d280812559df1255cecda7e3980afcdeee5))
* **repo:** point remaining user-facing links at canonical 1StepMore/AutoMedia ([f20ad96](https://github.com/1StepMore/AutoMedia/commit/f20ad96cc1fa1894ccd15b415bd6f6864cf71238))
* **repo:** re-point badges and URLs to canonical backup repo ([90a9113](https://github.com/1StepMore/AutoMedia/commit/90a9113cd861f40133598c60064bee361d0f8c98))
* **repo:** record canonical repo integration status through eab6dfe ([0adc027](https://github.com/1StepMore/AutoMedia/commit/0adc027710607269ab289932af482021f37fea34))
* **repo:** switch canonical remote to backup repo and document OIDC/Docker ownership ([7dcb1fe](https://github.com/1StepMore/AutoMedia/commit/7dcb1fee62dfb41d6c058d00701f124bb577a4b1))
* **roadmap:** correct verified factual errors vs codebase ([a39f7c0](https://github.com/1StepMore/AutoMedia/commit/a39f7c06991dfd025a098d8a5cc2c1e6ceb42234))
* **skills:** add validation-runner + deep-modules skills, extend doc-sync with ADR gate ([87cf369](https://github.com/1StepMore/AutoMedia/commit/87cf36950d8f243b45430d16282bb17ad874e727))
* **skills:** version all skills, sync issue-triage/pr-review-merge into claude+codex, extend doc-sync with inventory check (doc-hardening-pass2 step 8) ([09c146e](https://github.com/1StepMore/AutoMedia/commit/09c146eef3104a45594f7f57eccdbbb55dc7f53a))
* slim AGENTS.md 651 to 320 lines — index + progressive disclosure, keep red lines and tool tables (doc-hardening-pass2 step 5) ([1e2d8fe](https://github.com/1StepMore/AutoMedia/commit/1e2d8fe91799808c79b0721d491eb7ca4204c1b6))
* source-generated counts and inventory gate ([4f88384](https://github.com/1StepMore/AutoMedia/commit/4f88384a53f55f2868da68b6e3aebd1d592b7a3b))
* sync env/config/CLI/glossary/CHANGELOG docs with productization features ([4012b73](https://github.com/1StepMore/AutoMedia/commit/4012b737cea5daa6862e33f53655c5e2bde63fd4))
* **validation:** add loop governance section (contract, failure triage, archive map) ([#68](https://github.com/1StepMore/AutoMedia/issues/68)) ([fe3e50a](https://github.com/1StepMore/AutoMedia/commit/fe3e50ae12c2d76c7d870fb3e7d6b4115d3a4849))
* **validation:** AGENTS.md Validation Layer + doc drift fixes + guide + changelog ([b1c57c9](https://github.com/1StepMore/AutoMedia/commit/b1c57c9a83b75933a42159e85c7348b48bea3a61))
* **validation:** correct the stale expected-RED claims on the trace-propagation scenario ([#25](https://github.com/1StepMore/AutoMedia/issues/25)) ([c4b7df2](https://github.com/1StepMore/AutoMedia/commit/c4b7df23f038a3e6f69fdd002eccd01132935eaa))
* **validation:** correct the stale expected-RED claims on the trace-propagation scenario ([#25](https://github.com/1StepMore/AutoMedia/issues/25)) ([f93c339](https://github.com/1StepMore/AutoMedia/commit/f93c3391355c2bde5a7a3c67e8353615aea0c2c7))
* **validation:** dedupe 2026-08-16 pit list — keep only new pit [#8](https://github.com/1StepMore/AutoMedia/issues/8) ([7c73ba9](https://github.com/1StepMore/AutoMedia/commit/7c73ba9534d2a9af103e1801ae3fb262c8cd7bef))
* **validation:** document proves_gates/proves_modes and gate/mode coverage audit ([#78](https://github.com/1StepMore/AutoMedia/issues/78)) ([f5e7f20](https://github.com/1StepMore/AutoMedia/commit/f5e7f2087e672f80dddabbb91322726c5049df65))
* **validation:** first-run loop log — env pitfalls (PATH, dir deps, fake-LLM limits) ([#69](https://github.com/1StepMore/AutoMedia/issues/69)) ([0a1722c](https://github.com/1StepMore/AutoMedia/commit/0a1722c09005e1621099c36af28838ae33fcd347))
* **validation:** loop-log 2026-08-16 — 100 场景第二轮 + DeepSeek 间歇截断坑 ([76b2d1b](https://github.com/1StepMore/AutoMedia/commit/76b2d1b2e5d87dd77ff21d03ae81b950679f78fb))
* **validation:** LOOP-LOG 2026-08-16 — 100 场景第二轮 + DeepSeek 间歇截断坑 ([07b5cff](https://github.com/1StepMore/AutoMedia/commit/07b5cffad2301fe70e3d82e97da29415bf7357a9))
* **validation:** mock-aware evidence semantics ([c7cc6b0](https://github.com/1StepMore/AutoMedia/commit/c7cc6b066f026d4f9f5a3705f00cdd26a39b8edb))
* **validation:** revive LOOP-LOG with fix-retro 复盘记录 section ([7404c50](https://github.com/1StepMore/AutoMedia/commit/7404c50a739759d27d0c32085a52ec3e57340576))
* **validation:** revive LOOP-LOG with fix-retro 复盘记录 section ([e9c291b](https://github.com/1StepMore/AutoMedia/commit/e9c291bd81feb963523421f900cb95922c68ef4a))
* **validation:** SDK scope and meta tagging ([ec6208e](https://github.com/1StepMore/AutoMedia/commit/ec6208eb26f3b3455d2d03fbb9002ce700e94f99))
