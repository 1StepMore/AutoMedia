...
_TIER1_KEYWORDS: list[str] = [
    "aigc", "ai视频", "ai video", "自媒体工具", "ai绘画", "ai写作",
    "ai剪辑", "ai配音", "ai生成", "content creator", "ai content",
]
_TIER2_KEYWORDS: list[str] = [
    "人工智能", "大模型", "机器学习", "深度学习", "chatgpt", "gpt",
    "llm", "transformer", "ai agent", "ai助手",
]
_TIER3_KEYWORDS: list[str] = [
    "科技", "互联网", "芯片", "半导体", "云计算", "大数据",
    "5g", "区块链", "元宇宙", "vr", "ar",
]
