...
class ProductOptimizationAgent(BaseDecisionAgent):
    ...
    def _prioritise_features(
        ...
        if not candidates:
            candidates = [
                {"feature": "ai-powered_recommendations", "source": "default", "strategic_weight": 8, "market_pull": 9, "persona_alignment": 7},
                {"feature": "self_service_onboarding", "source": "default", "strategic_weight": 7, "market_pull": 8, "persona_alignment": 9},
                {"feature": "advanced_analytics_dashboard", "source": "default", "strategic_weight": 6, "market_pull": 7, "persona_alignment": 8},
                {"feature": "seamless_integration_api", "source": "default", "strategic_weight": 9, "market_pull": 6, "persona_alignment": 6},
                {"feature": "localisation_multi_currency", "source": "default", "strategic_weight": 7, "market_pull": 5, "persona_alignment": 5},
            ]
    ...
    def _generate_recommendations(
        ...
        if feature_priorities:
            ...
            recs.append(
                f"Prioritise engineering sprints for: {', '.join(top_3)}."
            )

        if localization_selling_points:
            recs.append(
                "Implement the localised selling-points in regional campaign briefs."
            )

        recs.append("Schedule quarterly product-positioning reviews to stay ahead of market shifts.")
        return recs
