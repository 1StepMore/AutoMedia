...
class ContentMarketingAgent(BaseDecisionAgent):
    ...
    def execute(
        ...
        channel_matrix = self._build_channel_matrix(
            brand_name, persona_map, market_report
        )
        calendar_framework = self._build_calendar_framework(
            content_pillars, channel_matrix
        )
    ...
    def _define_content_pillars(
        ...
        pains = persona_map.get("pain_points", [])
        gaps = competitor_matrix.get("content_gaps", [])
            ...
            return [
                {
                    ...
                    "description": p.get("description", f"Content pillar around {p.get('name', str(p))}"),
        ...
        pillar_defs = [
            {
                ...
                "description": "Original research and POV content that positions the brand as a category authority.",
            ...
            },
            {
                ...
                "description": "Real-world success narratives that build credibility and demonstrate ROI.",
            ...
            },
            {
                ...
                "description": "Interactive content that fosters peer-to-peer connection and advocacy.",
            ...
            },
            {
                ...
                "description": "Product-led content showcasing new features, roadmap, and technical depth.",
        ...
        if trends:
            pillar_defs.insert(
                ...
                {
                    "name": "trend_analysis",
                    "description": f"Timely commentary on {trends[0].lower() if isinstance(trends[0], str) else 'industry shifts'}.",
    ...
    def _build_calendar_framework(
        ...
        """
        pillar_names = [
            p["name"] for p in content_pillars if isinstance(p, dict)
        ]
        if not pillar_names:
