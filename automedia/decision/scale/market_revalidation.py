...
class MarketRevalidationAgent(BaseDecisionAgent):
    ...
    def execute(
        ...
        emerging_opportunities = self._find_opportunities(
            brand_name, market, existing_report
        )
        segment_recommendations = self._recommend_segments(
            brand_name, market, existing_report
        )
    ...
    @staticmethod
    def _analyse_trends(
        brand: str, market: str, data: dict[str, Any]
    ) -> list[str]:
        ...
        return [
            {
                ...
                "description": f"Segment of {market} buyers aged 25‑34 shows high intent but low brand awareness.",
                "potential": "high",
                "signal": "Competitor analysis reveals no dedicated messaging for this cohort.",
            },
            {
                "area": "adjacent_use_case",
                "description": f"Existing {brand} capability can be repurposed for {market} compliance workflows.",
                "potential": "medium",
            ...
            },
            {
                ...
                "description": "Freemium or usage-based tier could capture budget-conscious buyers.",
                "potential": "high",
