...
from automedia.omni.md5_integration import compute_md5, get_md5, has_changed, load_state, save_state, set_md5
...
def _register_builtins() -> None:
    """Auto-register the three built-in adapters on import."""
