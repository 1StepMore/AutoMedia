...
def _find_key(state: dict[str, Any], key: str) -> tuple[str | None, dict[str, Any] | None]:
    """Search for *key* across all omni_* sections. Returns (section_name, section_dict) or (None, None)."""
    for section in _OMNI_SECTIONS:
...
def set_md5(file_path: str | Path, state_dir: str | Path | None = None, section: str = "omni_extraction") -> str:
