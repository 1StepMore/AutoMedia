...
class OPPAdapter(BaseOmniAdapter):
    ...
    def extract(self, file_path: str, source_lang: str = "auto", target_lang: str = "auto") -> ExtractionResult:
        ...
        try:
            ...
            if cls is not None:
                ...
                return self.extract_md(result.content, source_lang=source_lang, target_lang=target_lang)
            ...
            return ExtractionResult(md_content="", manifest={"error": str(e)}, warnings=[f"Extraction failed: {e}"])
