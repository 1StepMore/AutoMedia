...
def _classify(node_name: str) -> str:
    ...
    decision_keywords = (
        "diagnosis", "positioning", "strategy", "optimization",
        "questionnaire", "routing", "confirmation", "planning",
        "audit", "refresh",
    )
    preference_keywords = (
        "segmentation", "persona", "audience", "calendar",
        "tracking", "revalidation", "deepening",
    )
